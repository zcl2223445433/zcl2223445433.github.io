...
import javax.swing.*;
	...
	//仿QQ登录界面
public class QQyemian extends JFrame {
    // 用户名
    ...
    public QQyemian() {
        ...
        // 设置窗体的标题图标
        Image image = new ImageIcon("d:/a.gif").getImage();
    ...
    public void init() {
        ...
        jl1 = new JLabel();
        // 设置背景图片
        Image image1 = new ImageIcon("d:/background.jpg").getImage();
        jl1.setIcon(new ImageIcon(image1));
        jl1.setBounds(0, 0, 355, 265);
         
        // QQ登录头像设定
        jl2 = new JLabel();
        Image image2 = new ImageIcon("d:/a.gif").getImage();
